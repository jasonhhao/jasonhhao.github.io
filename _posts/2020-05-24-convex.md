...
<p align="center"> 
  <img src="/imgs/convex/6.png" width="40%" height="40%">
</p>
...
但是对于怎么去求解这个原始问题的最优解我们还是不知道。那我们可不可以再找到一个对偶函数，让它的值也去等价于原始问题的值呢？答案是肯定的，所以我们可以定义另一个函数theta_D(x)作为原始问题的互补形式，也就是要求使得拉格朗日函数最小。

<p align="center"> 
  <img src="/imgs/convex/9.png" width="50%" height="50%">
</p>
