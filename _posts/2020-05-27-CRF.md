...
其中c是循环每一个团，所以ϕc和yc也就是相应属于该团的y和ϕ值。我们可以继续把每个团的ϕ定义为
...
<p align="center"> 
  <img src="/imgs/crf/8.png" width="90%" height="90%">
</p>
...
我们在这个公式里面唯一未知的变量就是w，因为f是我们自己定义的特征，所以我们是知道的。所以在给定数据集D的情况下我们可以使用最大似然估计来最大化
